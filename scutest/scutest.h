...
namespace scu{
	...
	void CopyHostName(int* i, string A_argv[], STORAGE_OPTIONS* A_options);
	void CopyPortName(int* i, string A_argv[], STORAGE_OPTIONS* A_options);
	void CopyPatientFirstName(int *i, string A_argv[],Patient* p);
	void CopyPatientLastName(int* i, string A_argv[],Patient* p);
	void CopyPatientId(int* i, string A_argv[],Patient* p);
	void CopyPatientSOPInstanceUID(int* i, string A_argv[],Patient* p);
	...
	int CheckHostDetails(STORAGE_OPTIONS* A_options);
